    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30" onClick={onClose}>
      ...
      >
        <div className="flex items-center justify-between mb-5">
          <h2 className="text-base font-semibold text-gray-800">Import from Notion</h2>
          ...
          >
            ...
            {uploading ? (
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <p className="text-sm font-medium text-gray-700">Drop your Notion export .zip here</p>
          ...
          <div className="mt-2 space-y-3">
            ...
            {result.errors.length > 0 && (
              <div className="text-xs text-gray-500 bg-gray-50 rounded p-3 space-y-1">
                <p className="font-medium text-gray-700">{result.errors.length} item{result.errors.length !== 1 ? 's' : ''} skipped:</p>
